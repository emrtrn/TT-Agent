# 8. Sınıf 1. Ünite — Hazırlık ve Üretim Planı

## 1. Ünite kimliği

| Alan | Doğrulanmış bilgi |
|---|---|
| Sınıf | 8 |
| Ünite | 1. Ünite — İnovatif Düşüncenin Geliştirilmesi, Fikirlerin Korunması ve Etik |
| Ders süresi | 8 ders saati (4 hafta, haftada 2 ders saati) |
| Öğrenme çıktısı | 3 |
| Birincil kaynak | https://tymm.meb.gov.tr/teknoloji-tasarim-dersi/unite/1446 |
| Kaynak güncelleme tarihi | 05.06.2026 |
| Son canlı doğrulama | 13.09.2026 |

Bu plan yardımcı çalışma belgesidir. Üretim sırasında canlı MEB sayfasıyla çelişirse resmî sayfa esas alınır.

## 2. Doğrulanmış öğrenme çıktıları
...
MEB sayfasındaki süreç bileşenleri ders planına aktarılırken kod, sıra ve anlam açısından yeniden kontrol edilecektir. Sayfadaki `TT. 8.1.3` gibi boşluk/noktalama farklılıkları yerel dokümanda standart `TT.8.1.3` biçiminde yazılacak, içerik anlamı değiştirilmeyecektir.

## 3. Doğrulanmış program bileşenleri

| Bileşen | Resmî sayfadaki kapsam |
|---|---|
| Alan becerisi | TSRMAB1 Tasarım Ürünü Oluşturma — TSRMAB1.1 Taslak Oluşturma |
| Kavramsal beceriler | KB2.6 Bilgi Toplama, KB2.8 Sorgulama |
| Eğilimler | E1.1 Merak, E2.2 Sorumluluk, E3.3 Yaratıcılık, E3.5 Açık Fikirlilik, E3.6 Analitiklik, E3.7 Sistematiklik |
| Sosyal-duygusal öğrenme | SDB1.1, SDB1.2, SDB2.1, SDB2.2, SDB2.3, SDB3.2, SDB3.3 |
| Değerler | D1 Adalet, D3 Çalışkanlık, D4 Dostluk, D19 Vatanseverlik |
| Okuryazarlık | OB1 Bilgi, OB2 Dijital, OB4 Görsel, OB7 Veri, OB8 Sürdürülebilirlik Okuryazarlığı |
| Disiplinler arası | Fen Bilimleri, Görsel Sanatlar, Bilişim Teknolojileri ve Yazılım |
| Beceriler arası | TSRMAB1.2 Tasarımı Ürüne Dönüştürme, TSRMAB3 Çoklu Ortam Sunum |

## 4. Resmî içerik çerçevesi

- İnovasyon ve AR-GE hakkında araştırma yapılarak inovatif bir ürün oluşturulabilmesi
- Fikrî ve sınai mülkiyet haklarıyla ilgili araştırma yapılabilmesi
- Anahtar kavramlar: etik, fikrî mülkiyet, inovasyon, sürdürülebilirlik

Resmî ön değerlendirme önerisi; inovasyon, AR-GE ve fikrî ve sınai mülkiyet hakları hakkındaki bilgi düzeyini ön testle belirlemektir. Köprü kurma önerisi, akıllı telefonların gelecekteki değişimini ve ürünü geliştiren kişilerin emeğinin korunmasını düşündürür.

## 5. 7. sınıftan alınan üretim düzeni ve 8. sınıf uyarlaması

7. sınıfta kaynak Markdown önce hazırlanmış, her ana dilim doğrulandıktan sonra diğer materyale geçilmiş, PDF/DOCX dönüşümü kaynaklardan ayrı tutulmuştur. Yazılı 7 adımlık iş akışı şu sıradaydı:

1. Ayrıntılı ders planı
2. Ön değerlendirme
3. Kavram kartları ve sunum içeriği
4. Çalışma kâğıtları
5. Değerlendirme araçları
6. Destekleme ve zenginleştirme
...
Bu dağılım resmî bir saat eşlemesi değil, ders planı hazırlanırken değerlendirilecek başlangıç önerisidir:

| Ders | Ana odak | Çıktı |
|---:|---|---|
| 1–2 | İnovasyon ve AR-GE kavramlarını sorgulama, gerçek ürünlerin gelişimini araştırma | TT.8.1.1 |
| 3–4 | İhtiyaç/problem belirleme, mevcut çözümleri inceleme ve inovatif fikir geliştirme | TT.8.1.2 |
| 5 | Ürün fikrinin çalışma mantığını gösteren eskiz ve taslak | TT.8.1.2 |
| 6–7 | Fikrî ve sınai mülkiyet türleri, güvenilir kurum araştırması ve koruma dosyası | TT.8.1.3 |
| 8 | Ürün fikri ile koruma yaklaşımının sunumu, öz/akran değerlendirme ve kapanış | TT.8.1.2–TT.8.1.3 |

## 8. Kabul kapıları

- Her içerik diliminde resmî çıktı ve süreç bileşeni eşleşmesi kontrol edilir.
- Her ders saati 40 dakika; ünite toplamı 8 ders saatidir.
- Öğrenci materyalleri 8. sınıf düzeyinde, öğretmen belgeleri uygulama odaklı yazılır.
- Kaynak Markdown onaylanmadan PDF/DOCX üretilmez.
- Otomatik çıktı kontrolü ile görsel/mizanpaj kabulü ayrı raporlanır.
- Sınav öğrenci kopyası ile cevap anahtarı ayrı çıktı olur.
- Canlı MEB sayfası her ana üretim adımının başlangıcında yeniden kontrol edilir.
- Sunum taslağındaki her kaynak geçişi `U1_Sunum_Entegrasyon_Haritasi.md` içinde kayıtlıdır.
- Kesin kaynak kimliği, kaynak portal kataloğunda oluşturulmadan yazılmaz.
- Sunum içi kaynak açılışı, kaynak kapanışı ve sunuma dönüş ayrı ayrı doğrulanır.
- Uzun videolar sunum içine bağlanmaz; ayrı Öğren kaynağı olarak değerlendirilir.
- Otomatik kontroller ile akıllı tahta/kullanıcı görsel kabulü ayrı durumlar olarak kaydedilir.
...
Bu bölüm her çalışma oturumunun sonunda güncellenir. Başka bir oturum işe başlamadan önce bu planı ve aşağıdaki kayıtları okumalıdır.
